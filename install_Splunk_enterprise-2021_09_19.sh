...
echo '##############################################'
echo '#                                            #'
echo '# Welcome to the Splunk 8.2.2 auto-installer #'
echo '# for RHEL/CentOS 7 x64.                     #'
echo '# Last updated 09/19/2021.                   #'
echo '#                                            #'
echo '##############################################'
echo
...
tar -xzvf /tmp/splunk-8.2.2-87344edfcdb4-Linux-x86_64.tgz -C /opt
rm -f /tmp/splunk-8.2.2-87344edfcdb4-Linux-x86_64.tgz
echo
