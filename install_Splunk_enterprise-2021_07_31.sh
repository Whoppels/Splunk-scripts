...
echo '##############################################'
echo '#                                            #'
echo '# Welcome to the Splunk 8.1.5 auto-installer #'
echo '# for RHEL/CentOS 7 x64.                     #'
echo '# Last updated 07/31/2021.                   #'
echo '#                                            #'
echo '##############################################'
echo
...
cd /tmp
wget -O splunk-8.1.5-9c0c082e4596-Linux-x86_64.tgz 'https://www.splunk.com/bin/splunk/DownloadActivityServlet?architecture=x86_64&platform=linux&version=8.1.5&product=splunk&filename=splunk-8.1.5-9c0c082e4596-Linux-x86_64.tgz&wget=true'
...
tar -xzvf /tmp/splunk-8.1.5-9c0c082e4596-Linux-x86_64.tgz -C /opt
rm -f /tmp/splunk-8.1.5-9c0c082e4596-Linux-x86_64.tgz
echo
